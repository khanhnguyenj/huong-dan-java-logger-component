...
/**
 * A <code>HuongDanJavaLoggerComponentConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link HuongDanJavaLoggerComponentConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2018-01-02T04:15:48+07:00", comments = "Build UNNAMED.2793.f49b6c7")
public class HuongDanJavaLoggerComponentConnectorLifecycleInjectionAdapter
    extends HuongDanJavaLoggerComponentConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(HuongDanJavaLoggerComponentConnectorLifecycleInjectionAdapter.class);
